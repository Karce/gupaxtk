...
mv xmrig-6.22.0/xmrig /tmp/${FOLDER}/skel/linux_b/xmrig/xmrig
rm -r xmrig-6.22.0
rm xmrig-6.22.0-linux-static-x64.tar.gz 
# download xmrig into directory macos-arm64
wget https://github.com/xmrig/xmrig/releases/download/v6.22.0/xmrig-6.22.0-macos-arm64.tar.gz
tar -xf xmrig-6.22.0-macos-arm64.tar.gz
mv xmrig-6.22.0/xmrig /tmp/${FOLDER}/skel/macos-arm64_b/Gupaxx.app/Contents/MacOS/xmrig/xmrig
rm -r xmrig-6.22.0
rm xmrig-6.22.0-macos-arm64.tar.gz
# download xmrig into directory macos-x64
wget https://github.com/xmrig/xmrig/releases/download/v6.22.0/xmrig-6.22.0-macos-x64.tar.gz
tar -xf xmrig-6.22.0-macos-x64.tar.gz
mv xmrig-6.22.0/xmrig /tmp/${FOLDER}/skel/macos-x64_b/Gupaxx.app/Contents/MacOS/xmrig/xmrig
rm -r xmrig-6.22.0
rm xmrig-6.22.0-macos-x64.tar.gz
# download xmrig into directory windows
wget https://github.com/xmrig/xmrig/releases/download/v6.22.0/xmrig-6.22.0-msvc-win64.zip
unzip xmrig-6.22.0-msvc-win64.zip
mv xmrig-6.22.0/xmrig.exe /tmp/${FOLDER}/skel/windows_b/XMRig/xmrig.exe
rm -r xmrig-6.22.0
rm xmrig-6.22.0-msvc-win64.zip
